 ...
 */
const DEFAULT_SYSTEM_PROMPT = 'Rewrite the following research paper title into a catchy, engaging title in under 10 words, and summarize the core finding in strictly under 80 words for a mobile flashcard. Only return the new title, without quotes or additional text.\n\nOriginal Title: {{originalTitle}}\nSummary: {{summary}}';
